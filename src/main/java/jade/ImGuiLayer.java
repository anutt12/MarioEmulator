...
public class ImGuiLayer {
    ...
    public void initImGui() throws IOException {
        // IMPORTANT!!
        ...
        String url = properties.getProperty("font_url");
        ...
        if (new File(url).isFile()) {
            ...
            fontAtlas.addFontFromFileTTF(url, 32, fontConfig);
            fontConfig.destroy(); // After all fonts were added we don't need this config more
        } else if (new File("/Library/Fonts/Arial Unicode.ttf").isFile()) {
            // Fallback font
            ...
            // Fonts merge example
            fontConfig.setPixelSnapH(true);
            fontAtlas.addFontFromFileTTF("/Library/Fonts/Arial Unicode.ttf", 32, fontConfig);
            fontConfig.destroy(); // After all fonts were added we don't need this config more
        }
